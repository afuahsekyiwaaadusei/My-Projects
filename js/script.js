...
const exit_btn = DOMSelector(
  DOMSelector(document, "method", ".info_box"),
  "method",
  ".buttons .quit"
);
...
const continue_btn = DOMSelector(
  DOMSelector(document, "method", ".info_box"),
  "method",
  ".buttons .restart"
);
  ...
  function setOnclickAttribute(i = 0) {
    if (i < option.length) {
      ...
      DOMManipulate(
        ...
        "setAttribute",
        "onclick",
        "optionSelected(this, DOMSelector, DOMManipulate, mutatingVariables,Data)"
      );
